 ...
 * @method static \Database\Factories\ProvinsiFactory                    factory($count = null, $state = [])
 ...
 * @property string $rfs_date
 * @property string $code
 * @property string $name
 * @method static \Illuminate\Database\Eloquent\Builder<static>|Provinsi whereCode($value)
 * @method static \Illuminate\Database\Eloquent\Builder<static>|Provinsi whereName($value)
 * @method static \Illuminate\Database\Eloquent\Builder<static>|Provinsi whereRfsDate($value)
 * @mixin \Eloquent
 */
